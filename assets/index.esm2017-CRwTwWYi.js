import{n as g,_ as y,p as I,t as C,F as D,v as O,C as _,x as N}from"./index-DwZGzGNr.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const H="auth-internal",J="app-check-internal",V="messaging-internal";function B(e,t){const n=(r,{instanceIdentifier:i})=>{const o=r.getProvider("app").getImmediate(),s=r.getProvider(H),a=r.getProvider(V),l=r.getProvider(J);return new R(o,s,a,l,i,e)};O(new _(m,n,"PUBLIC").setMultipleInstances(!0)),N(A,k,t),N(A,k,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function K(e=C(),t=d){const r=y(g(e),m).getImmediate({identifier:t}),i=I("functions");return i&&X(r,...i),r}function X(e,t,n){U(g(e),t,n)}function q(e,t,n){return x(g(e),t)}B(fetch.bind(self));export{K as g,q as h};
