...
export const lessonsData = {
    ...
    resumen: [
        {
            id: 1,
            title: "Resumen General: Pruebas MEP 2026",
            description: "Resumen completo de Estudios Sociales para la preparación de las pruebas nacionales.",
            sections: [
                {
                    title: "1. Propósito de los Estudios Sociales",
                    content: [
                        "<p>Los Estudios Sociales nos ayudan a comprender nuestra historia, conocer la geografía del país y formarnos como ciudadanos responsables.</p>",
                        "<p><strong>Educación Cívica:</strong> Es una parte fundamental que nos enseña valores como el respeto, la democracia y la responsabilidad para vivir en sociedad.</p>",
                        "<h4>Preguntas de repaso</h4><ul><li>¿Cuál es el propósito principal de estudiar Estudios Sociales?</li><li>¿Qué valores nos enseña la Educación Cívica?</li></ul>"
                    ]
                },
                {
                    title: "2. Geografía de Costa Rica",
                    content: [
                        "<h3>Ubicación</h3><p>Costa Rica se encuentra en Centroamérica, en el hemisferio norte y occidental, entre el Mar Caribe y el Océano Pacífico.</p>",
                        "<h3>Relieve</h3><p>Contamos con cuatro cordilleras principales: Guanacaste, Tilarán, Central y Talamanca. Además de llanuras y costas en ambos océanos.</p>",
                        "<h3>Ventajas y Desventajas</h3><ul><li><strong>Ventajas:</strong> Biodiversidad, acceso a dos océanos, turismo.</li><li><strong>Desventajas:</strong> Riesgos naturales como terremotos, inundaciones y actividad volcánica.</li></ul>",
                        "<h4>Preguntas de repaso</h4><ul><li>¿Cuáles son las cuatro cordilleras principales del país?</li><li>Mencione dos ventajas y dos desventajas de nuestra ubicación geográfica.</li></ul>"
                    ]
                },
                {
                    title: "3. Pueblos Originarios",
                    content: [
                        "<p>Costa Rica tiene 8 etnias indígenas principales: Bribris, Cabécares, Chorotegas, Borucas, Malekus, Ngäbes, Térrabas y Huetares.</p>",
                        "<h3>Legado Cultural</h3><ul><li><strong>Agricultura:</strong> Maíz, frijoles y cacao.</li><li><strong>Arte:</strong> Esferas de piedra, cerámica y orfebrería.</li><li><strong>Valores:</strong> Respeto profundo por la naturaleza.</li></ul>",
                        "<h4>Preguntas de repaso</h4><ul><li>Mencione tres etnias indígenas de Costa Rica.</li><li>¿Qué productos agrícolas heredamos de nuestros antepasados?</li></ul>"
                    ]
                },
                {
                    title: "4. Historia Nacional",
                    content: [
                        "<ul>",
                        "<li><strong>Conquista (1502):</strong> Llegada de los españoles y cambios culturales profundos.</li>",
                        "<li><strong>Independencia (1821):</strong> El 15 de septiembre nos liberamos del dominio español. El <strong>Pacto de Concordia</strong> fue nuestra primera constitución.</li>",
                        "<li><strong>Campaña Nacional (1856-1857):</strong> Defensa contra los filibusteros de William Walker liderada por Juan Rafael Mora Porras.</li>",
                        "<li><strong>Reformas Liberales:</strong> Impulso a la educación gratuita y el ferrocarril.</li>",
                        "<li><strong>Reformas Sociales (1940):</strong> Creación de la CCSS, el Código de Trabajo y la UCR.</li>",
                        "</ul>",
                        "<h4>Preguntas de repaso</h4><ul><li>¿En qué fecha se celebra la independencia de Costa Rica?</li><li>¿Qué fue el Pacto de Concordia?</li><li>Mencione dos reformas sociales importantes de la década de 1940.</li></ul>"
                    ]
                },
                {
                    title: "5. Educación Cívica y Valores",
                    content: [
                        "<h3>Símbolos Patrios</h3><p>La Bandera, el Escudo y el Himno Nacional representan nuestra identidad y libertad.</p>",
                        "<h3>Derechos y Deberes</h3><ul><li><strong>Derechos:</strong> Educación, salud, igualdad y libertad.</li><li><strong>Deberes:</strong> Respetar las leyes, cuidar el ambiente y respetar a los demás.</li></ul>",
                        "<h4>Preguntas de repaso</h4><ul><li>¿Qué representan los símbolos nacionales?</li><li>Mencione dos derechos y dos deberes que tenemos como ciudadanos.</li></ul>"
                    ]
                },
                {
                    title: "6. Ambiente y Comunidad",
                    content: [
                        "<p>La protección del medio ambiente es una responsabilidad compartida. Debemos practicar el reciclaje, el ahorro de energía y agua, y participar activamente en nuestras comunidades.</p>",
                        "<h4>Preguntas de repaso</h4><ul><li>¿Qué acciones podemos tomar en casa para proteger la naturaleza?</li><li>¿Por qué es importante participar en las actividades de la comunidad?</li></ul>"
                    ]
                },
                {
                    title: "7. Evaluación de la Prueba",
                    content: [
                        "<p>Las pruebas MEP evalúan no solo la memoria, sino la capacidad de comprender textos, interpretar mapas, analizar causas de hechos históricos y aplicar valores democráticos en la vida diaria.</p>",
                        "<h4>Preguntas de repaso</h4><ul><li>¿Qué habilidades busca medir la prueba estandarizada?</li></ul>"
                    ]
                }
            ],
            quiz: [
                {
                    question: "¿Cuál es la capital histórica de Costa Rica durante la colonia?",
                    options: ["San José", "Alajuela", "Cartago"],
                    correct: 2
                },
                {
                    question: "¿Qué etnia indígena es famosa por las esferas de piedra?",
                    options: ["Borucas (Diquís)", "Chorotegas", "Malekus"],
                    correct: 0
                }
            ]
        }
