    ...
    const subjects = [
        {
            ...
            status: 'Disponible',
            disabled: false,
            link: '/ciencias/grade/6/lesson/1'
        },
        {
            id: 'sociales',
            ...
            status: 'Disponible',
            disabled: false,
            link: '/sociales/grade/6/lesson/1'
        },
        {
            id: 'matematicas',
            name: 'Matemáticas',
        ...
        },
        {
            ...
            status: 'Disponible',
            disabled: false,
            link: '/espanol/grade/6/lesson/1'
        }
    ];

    return (
        <div className="subject-selection-page">
            <section className="hero" style={{ background: 'radial-gradient(circle at top right, rgba(46, 204, 113, 0.15), transparent), radial-gradient(circle at bottom left, rgba(52, 152, 219, 0.05), transparent)', padding: '5rem 0', textAlign: 'center' }}>
                <div className="container">
                    <span className="badge">Plataforma 6to Grado</span>
                    <h1 style={{ fontSize: '3.5rem', marginBottom: '1.5rem', background: 'linear-gradient(135deg, var(--bg-dark) 0%, var(--primary) 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', lineHeight: '1.2' }}>
                        Domina tus Materias con EduPortal CR
                    </h1>
                    <p style={{ fontSize: '1.3rem', maxWidth: '800px', margin: '0 auto 2.5rem auto', lineHeight: '1.6', color: 'var(--text-main)' }}>
                        La herramienta educativa más completa para estudiantes de <strong>6to Grado</strong>. Aprende, practica y domina cada tema con contenido diseñado para tu éxito.
                    </p>
            ...
            <section id="materias" className="container" style={{ padding: '4rem 0' }}>
                <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
                    <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '2.5rem', color: 'var(--bg-dark)' }}>Elige tu Materia</h2>
                    <p style={{ color: 'var(--text-muted)' }}>Selecciona el área de estudio que deseas explorar hoy.</p>
                </div>
            ...
            <section style={{ padding: '5rem 0', background: 'white' }}>
                <div className="container">
                    <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                        <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: '2.5rem', marginBottom: '1rem' }}>Todo lo que necesitas para tu estudio</h2>
                        <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem' }}>Metodología interactiva diseñada para 6to grado.</p>
                    </div>

                    <div className="features-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2.5rem' }}>
                        <div style={{ padding: '2.5rem', background: '#f8fafc', borderRadius: '24px' }}>
                            <div style={{ fontSize: '3rem', marginBottom: '1.5rem' }}>📝</div>
                            <h4 style={{ marginBottom: '1rem', fontSize: '1.4rem' }}>Resúmenes Claros</h4>
                            <p style={{ color: 'var(--text-muted)', lineHeight: '1.6' }}>Sìntesis de los contenidos oficiales del MEP para que estudies lo que realmente importa.</p>
                        </div>

                        <div style={{ padding: '2.5rem', background: '#f8fafc', borderRadius: '24px' }}>
                            <div style={{ fontSize: '3rem', marginBottom: '1.5rem' }}>📖</div>
                            <h4 style={{ marginBottom: '1rem', fontSize: '1.4rem' }}>Lecciones Variadas</h4>
                            <p style={{ color: 'var(--text-muted)', lineHeight: '1.6' }}>Contenido estructurado por temas con explicaciones paso a paso y material visual.</p>
                        </div>

                        <div style={{ padding: '2.5rem', background: '#f8fafc', borderRadius: '24px' }}>
                            <div style={{ fontSize: '3rem', marginBottom: '1.5rem' }}>🔡</div>
                            <h4 style={{ marginBottom: '1rem', fontSize: '1.4rem' }}>Preguntas Aleatorias</h4>
                            <p style={{ color: 'var(--text-muted)', lineHeight: '1.6' }}>Bancos de preguntas que se seleccionan al azar para que cada práctica sea un nuevo reto.</p>
                        </div>

                        <div style={{ padding: '2.5rem', background: '#f8fafc', borderRadius: '24px' }}>
                            <div style={{ fontSize: '3rem', marginBottom: '1.5rem' }}>📂</div>
                            <h4 style={{ marginBottom: '1rem', fontSize: '1.4rem' }}>Material Adicional</h4>
                            <p style={{ color: 'var(--text-muted)', lineHeight: '1.6' }}>Descarga exámenes de práctica y material extra para reforzar tus conocimientos.</p>
                        </div>
                    </div>
                </div>
            </section>
